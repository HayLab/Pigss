...
# region old_gametes
    ...
    #     ovules = rng.choice(range(len(self.haplotypes)), size=num_offspring*mother_count, p = poss_gamete_chances)
    ...
    #     pollen = rng.choice(range(len(self.haplotypes)), size=num_offspring*father_count, p = poss_gamete_chances)
